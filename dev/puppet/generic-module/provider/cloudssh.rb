...
module CloudSSH
   ...
   def self.copy_ssh_key(ip, password, module_name, path = SSH_PATH, file = SSH_KEY)
   
      puts "Copying ssh key..."
      command_path = "/etc/puppet/modules/#{module_name}/lib/puppet/provider/#{module_name}/ssh"
