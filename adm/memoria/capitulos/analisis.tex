...
\begin{figure} [!htbp]
  \centering
%  \includegraphics[width=0.8\textwidth]{imagenes/AppScale_Stack.png}
...
Como muchos de estos roles deberían estar juntos en una máquina, se han creado unos alias para facilitar el despliegue de la infraestructura:
