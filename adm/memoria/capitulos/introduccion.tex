...
% TODO Comprobar que están en el mismo orden que el capítulo Metodología.
\begin{enumerate}
...
\begin{itemize}
\item KVM, QEMU, libvirt y virsh para el soporte y la grstión de las máquinas virtuales.
...
\item[Capítulo \ref{cap:trabajo}] Extensión de Puppet para gestión de infraestructuras distribuidas.
\item[Capítulo \ref{cap:appscale}] Uso de la extensión de Puppet para gestión de infraestructura AppScale.
\item[Capítulo \ref{cap:web}] Uso de la extensión de Puppet para gestión de infraestructura web de tres niveles.
\item[Capítulo \ref{cap:torque}] Uso de la extensión de Puppet para gestión de infraestructura de trabajos distribuidos.
