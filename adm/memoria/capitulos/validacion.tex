...
También es necesario haber instalado una serie de tecnologías para que las pruebas puedan realizarse. Todas las infraestructuras deben tener instalado MCollective \ref{anx:inst-mcollective} y RabbitMQ \ref{anx:inst-rabbitmq} para poder enviar órdenes a todos los nodos a la vez. Asimismo deben tener instalada la herramienta de monitorización God \ref{anx:inst-god} para realizar la monitorización de algunos procesos. Por supuesto, todos deben tener instalado Puppet \ref{anx:inst-puppet}
