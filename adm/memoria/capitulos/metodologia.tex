...
Una vez que el modelado se ha completado es hora de abarcar la metodología que se seguirá para diseñar e implementar nuevos recursos distribuidos. Para ello se usarán las facilidades que proporciona la herramienta de gestión de configuración para ampliar su funcionalidad.
