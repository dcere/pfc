...
Dentro de las funciones \texttt{start} y \texttt{stop} se puede hacer uso de las funciones especificadas en la sección \emph{Framework de implementación} en el capítulo \ref{cap:modelado}.
