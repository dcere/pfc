...
\include{capitulos/modelado}
\include{capitulos/metodologia}
\include{capitulos/disenyo}
...
%\include{anexos/ejemplo}
%\include{anexos/puppet-language}
%\include{anexos/appscale}

%\include{anexos/instalacion}

%\include{anexos/instalacion/appscale}
%\include{anexos/instalacion/torque}
%\include{anexos/instalacion/web}
%\include{anexos/instalacion/ruby}
%\include{anexos/instalacion/libvirt}
%\include{anexos/instalacion/mcollective}
%\include{anexos/instalacion/rabbitmq}
%\include{anexos/instalacion/puppet}
%\include{anexos/instalacion/neptune}
%\include{anexos/instalacion/god}

%\include{anexos/codigo/codigo}
