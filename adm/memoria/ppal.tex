...
%\include{apendices/comun/ruby}
%\include{apendices/comun/libvirt}
%\include{apendices/comun/rabbitmq}
%\include{apendices/comun/mcollective}
%\include{apendices/comun/puppet}
%\include{apendices/web/web}
